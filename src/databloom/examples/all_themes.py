#!/usr/bin/env python3
"""All themes demo — generates a report for each of the 10 built-in themes.
...
for theme_name in list_themes():
    ...
    report = (
        ...
        .add_chart(chart_df, type="column", category_col="Month",
                   value_cols=["Revenue", "Target"], title="Revenue vs Target")
        .add_sheet("Details")
