...
from databloom.elements.chart import ChartElement, ChartType
from databloom.elements.table import TableElement
from databloom.elements.text import (
    ParagraphElement,
    SubtitleElement,
    TitleElement,
)
...
def layout_dashboard(
    ...
    for i, (df, ct, ct_title) in enumerate(zip(chart_dfs, types, titles, strict=False)):
        engine.place(
            ChartElement(df, chart_type=ct, title=ct_title, full_width=False),
