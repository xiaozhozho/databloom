...
class GridConfig:
    ...
    margin_top: int = field(default_factory=lambda: settings.grid.margin_top)
    margin_left: int = field(default_factory=lambda: settings.grid.margin_left)
    spacing: int = field(default_factory=lambda: settings.grid.element_spacing)
    default_col_width_chars: float = field(default_factory=lambda: settings.grid.default_col_width)
...
class Grid:
    ...
    def __init__(
        ...
        self.margin_top = margin_top if margin_top is not None else settings.grid.margin_top
        self.margin_left = margin_left if margin_left is not None else settings.grid.margin_left
        self.spacing = spacing if spacing is not None else settings.grid.element_spacing
        self.default_col_width = (
            default_col_width if default_col_width is not None else settings.grid.default_col_width
        )
