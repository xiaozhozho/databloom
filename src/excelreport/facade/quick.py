...
from excelreport.layout.templates import layout_simple, layout_summary_detail
...
def quick_report(
    *dataframes: pd.DataFrame,
    ...
    if not dfs:
        ...
        from excelreport.elements.text import ParagraphElement, TitleElement
